...
LOGIN_REDIRECT_URL = 'dashboard_redirect'  # The name of the URL pattern for your custom redirect view 
...
SECRET_KEY = 'django-insecure--an1$l)#onz7lj$3!5^6un98$&(fz45f&y=56*e1^g^sgqeky8'
